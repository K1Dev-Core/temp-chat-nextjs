...
export default function NotesPage() {
    ...
    // Utility functions for note viewing
            ...
            if (urlRegex.test(part)) {
                return (
                    <a
                        ...
                        className="transition-colors hover:opacity-70 underline"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4">
                                        {predefinedTags.map(tag => (
                                            <button
                                                ...
                                                className={`px-3 py-2 text-sm rounded-lg transition-colors text-left ${formData.tags.includes(tag) ? 'text-white' : ''
                                                    }`}
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <div className="flex items-center gap-3">
                                    <button
                                        onClick={() => copyToClipboard(viewingNote.content)}
                            ...
                            <div className="mb-6">
                                ...
                                >
                                    {renderContentWithLinks(viewingNote.content)}
                                </div>
                            </div>
                            ...
                            {viewingNote.tags.length > 0 && (
                                <div className="mb-6">
                                    <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--text-secondary)' }}>Tags:</h3>
                                    <div className="flex flex-wrap gap-2">
                            ...
                            {/* Note Metadata */}
                            <div className="flex items-center justify-between text-sm pt-4" style={{ borderTop: '1px solid var(--border-primary)', color: 'var(--text-muted)' }}>
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-1">
                                        <User className="w-4 h-4" />
                                        <span>Author: {viewingNote.author}</span>
                                    </div>
                                    <div className="flex items-center gap-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className="flex items-center gap-1 px-3 py-1 rounded transition-colors hover:opacity-70"
                                        style={{ color: 'var(--accent-blue)' }}
                                    >
                                        <Edit3 className="w-4 h-4" />
                                        <span>Edit</span>
